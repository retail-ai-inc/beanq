 ...
 * @internal
 */
export declare function withCache(cacheInstance: Cache | undefined, key: any[], valueFactory: ValueFactory): Promise<any>;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare function transformJSCode(source: string, moduleSourceType: boolean, filename: AbstractPath, additionalBabelParserPlugins: Options['additionalBabelParserPlugins'], additionalBabelPlugins: Options['additionalBabelPlugins'], log: Options['log'], devMode?: boolean): Promise<[string[], string]>;
export declare function loadModuleInternal(pathCx: PathContext, options: Options): Promise<ModuleExport>;
/**
 * Create a cjs module
 * @internal
 */
export declare function defaultCreateCJSModule(refPath: AbstractPath, source: string, options: Options): Module;
/**
 * @internal
 */
