const Langs = [
    ...
    {label:"日本語 (Japanese)",index:1, flag:"jp"},
];
const OtherBtn = [
    {label:"Search",mark:"Search",en:"Search",jp:"検索"},
    {label:"LogOut",mark:"LogOut",en:"LogOut",jp:"ログアウト"},
    {label:"Close",mark:"Close",en:"Close",jp:"閉じる"},
    {label:"SureDelete",mark:"SureDelete",en:"Are you sure Delete？",jp:"本当に削除しますか？"}
];
const Nav = [
    ...
    {id:4,label:"Log",mark:"Log",en:"Log",jp:"ログ",to:"/admin/home",tos:["/admin/log/event","/admin/log/dlq","/admin/log/workflow"],value:"log",pid:0,children:[
            {id:5,label:"Event Log",mark:"Event",en:"Event Log",jp:"イベントログ",to:"/admin/log/event",value:"/event_log/list",pid:4,children:[
            ...
            {id:9,label:"DLQ Log",mark:"DLQ",en:"DLQ Log",jp:"DLQ Log",to:"/admin/log/dlq",value:"",pid:4,children: [
            ...
            {id:13,label: "Workflow Log",mark:"Workflow",en:"Workflow Log",jp:"Workflow Log",to:"/admin/log/workflow",value:"",pid:4,children: [
    ...
    {id:20,label:"Setting",mark:"Setting",en:"Setting",jp:"設定",tos:["/admin/optLog","/admin/user"],value:"",pid:0,children: [
            {id:21,label:"Operation Log",mark:"Operation",en:"Operation Log",jp:"Operation Log",to:"/admin/optLog",value:"/log/opt_log",pid:20,children: [
