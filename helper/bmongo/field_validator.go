		...
		EventType: bson.D{
			{Key: "$jsonSchema", Value: bson.D{
				...
				{Key: "properties", Value: bson.D{
					...
					{Key: "maxLen", Value: bson.D{{Key: "bsonType", Value: bson.A{"int", "string", "double"}}}},
					{Key: "timeToRun", Value: bson.D{{Key: "bsonType", Value: bson.A{"int", "string", "double"}}}},
					{Key: "retry", Value: bson.D{{Key: "bsonType", Value: bson.A{"int", "string", "double"}}}},
					{Key: "addTime", Value: bson.D{{Key: "bsonType", Value: "date"}}},
					{Key: "executeTime", Value: bson.D{{Key: "bsonType", Value: "date"}}},
					{Key: "payload", Value: bson.D{{Key: "bsonType", Value: "string"}}},
					{Key: "priority", Value: bson.D{{Key: "bsonType", Value: bson.A{"int", "string", "double"}}}},
				}},
			}},
		},
		ManagerType: bson.D{
			{Key: "$jsonSchema", Value: bson.D{
				...
				{Key: "properties", Value: bson.D{
					...
					{Key: "active", Value: bson.D{{Key: "bsonType", Value: bson.A{"int", "string", "double"}}}},
